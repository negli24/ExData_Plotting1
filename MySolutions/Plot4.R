...
plot(power_cons_short$datetime,power_cons_short$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(power_cons_short$datetime,power_cons_short$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()